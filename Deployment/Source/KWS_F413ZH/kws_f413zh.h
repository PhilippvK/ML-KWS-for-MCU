...
#ifndef __KWS_F413ZH_H__
#define __KWS_F413ZH_H__
...
//class KWS_F413ZH : public KWS_DS_CNN {
class KWS_F413ZH : public KWS_DNN {
public:
  KWS_F413ZH(int recording_win, int sliding_window_len);
  ~KWS_F413ZH();
  void start_kws();
